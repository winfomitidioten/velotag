...
<template>
    <!-- Das Zahnrad zu den Einstellungen sitzt im Profil selbst (/profile,
         PublicUserProfile.vue) - hier auf der Bearbeiten-Seite waere es doppelt. -->
    <PageHeader v-if="!isMobile"></PageHeader>
