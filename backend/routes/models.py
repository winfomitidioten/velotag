...
class Route (models.Model): 
    ...
    polyline_map = models.TextField(blank=True, null=True, help_text="Google Komprimierungsalgorithmus für Koordinaten")
    puls_stream = models.JSONField(blank=True, null=True, help_text="Array: Pulswerte")
    zeit_stream = models.JSONField(blank=True, null=True, help_text="Array: Zeitstempel für Geschwindigkeitslogik")
